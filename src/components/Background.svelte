<script lang="ts">
  ...
  onMount(() => {
    ...
    const canvasElements: any = document.querySelectorAll('[data-particle-animation]');
...
<main>
  <div class="relative font-inter antialiased">
    ...
    <main class="relative min-h-screen flex flex-col justify-center bg-[#060213] overflow-hidden">
    ...
    <footer class="absolute left-6 right-6 md:left-12 md:right-auto bottom-4 md:bottom-8 text-center md:text-left">
        <a class="text-xs text-slate-500 hover:underline" href="https://github.com/thiagodeev">Made by Thiagodeev - 2023</a>
    </footer>
